...
@Tag(name = "饮食健康咨询", description = "饮食健康AI对话会话和消息管理接口")
public class ChatController {
    ...
    @Operation(summary = "创建饮食咨询会话", description = "创建新的饮食健康咨询会话")
    ...
    @Operation(summary = "发送咨询消息", description = "发送饮食健康咨询消息并获取AI智能回复")
